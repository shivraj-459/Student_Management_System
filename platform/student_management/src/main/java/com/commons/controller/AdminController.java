...
public class AdminController {
	...
	@PostMapping("/admins")
	public ResponseEntity<AdminDTO> addAdminHandler(@Valid @RequestBody Admin admin) throws AdminException, ValidationException{
	...
	public ResponseEntity<StudentOutputDTO> addStudentHandler(@Valid @RequestBody Student student,@PathVariable("adminuuid") String uuid) throws StudentException, AdminException, LoginException{
	...
	@GetMapping("/coursestudents/{courseId}/{adminuuid}")
	public ResponseEntity<List<StudentOutputDTO>> getStudentByCourse(@PathVariable("courseId") Integer courseId,@PathVariable("adminuuid") String uuid) throws CourseException, StudentException, LoginException{
		
		
		List<StudentOutputDTO> list= adminService.getStudentByCourse(courseId, uuid);
